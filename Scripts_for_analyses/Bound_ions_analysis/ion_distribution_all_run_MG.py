...
systems = [
    {
        ...
        "topology": "../MG_15mM_1264_Box_50_rw.prmtop",
        "trajectory_files": [
            "../MG_15mM_1264_Box_50_run1_rw.nc",
            "../MG_15mM_1264_Box_50_run2_rw.nc",
            "../MG_15mM_1264_Box_50_run3_rw.nc"
        ]
    },
]
...
for system_index, system in enumerate(systems):
    ...
    for run_index, traj_file in enumerate(trajectory_files):
        ...
        ca_ions = u.select_atoms("resname MG")
        ...
        with open(output_file, "w") as file:
            file.write("Frame,minor_groove,major_groove,DNA_backbone,DNA_gap,histone_tail,histone_core,interface\n")
            ...
            for ts in u.trajectory[2500:12500:25]:
                ...
                file.write(f"{ts.frame},{ions_in_only_minor_groove},{ions_in_only_major_groove},{ions_in_only_dna_backbone},{ions_in_only_gap},{ions_in_only_histone_tail},{ions_in_only_histone_core},{ions_in_interface}\n")
