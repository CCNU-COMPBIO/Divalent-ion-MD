foreach name  {NaCl_Box_30 CA_15mM_1264_Box_30 MG_15mM_1264_Box_30 } {

mol delete all
mol load parm7 ../${name}_rw.prmtop
mol addfile ../${name}_run1_rw.nc first 2500 last 12500 step 10 waitfor all
mol addfile ../${name}_run2_rw.nc first 2500 last 12500 step 10 waitfor all
mol addfile ../${name}_run3_rw.nc first 2500 last 12500 step 10 waitfor all


source rename_chainID_with_tail.tcl
set nframes [expr  [molinfo top get numframes] - 1 ]

set outfile11 [open ./tail_dna/tail_DNA_mean_contacts_all_${name}_h3_A.dat w]
set outfile12 [open ./tail_dna/tail_DNA_mean_contacts_all_${name}_h3_E.dat w]
set outfile13 [open ./tail_dna/tail_DNA_mean_contacts_backbone_${name}_h3_A.dat w]
set outfile14 [open ./tail_dna/tail_DNA_mean_contacts_backbone_${name}_h3_E.dat w]
set outfile15 [open ./tail_dna/tail_DNA_mean_contacts_base_${name}_h3_A.dat w]
set outfile16 [open ./tail_dna/tail_DNA_mean_contacts_base_${name}_h3_E.dat w]

set outfile21 [open ./tail_dna/tail_DNA_mean_contacts_all_${name}_h4_B.dat w]
set outfile22 [open ./tail_dna/tail_DNA_mean_contacts_all_${name}_h4_F.dat w]
set outfile23 [open ./tail_dna/tail_DNA_mean_contacts_backbone_${name}_h4_B.dat w]
set outfile24 [open ./tail_dna/tail_DNA_mean_contacts_backbone_${name}_h4_F.dat w]
set outfile25 [open ./tail_dna/tail_DNA_mean_contacts_base_${name}_h4_B.dat w]
set outfile26 [open ./tail_dna/tail_DNA_mean_contacts_base_${name}_h4_F.dat w]

set outfile31 [open ./tail_dna/tail_DNA_mean_contacts_all_${name}_h2a_C.dat w]
set outfile32 [open ./tail_dna/tail_DNA_mean_contacts_all_${name}_h2a_G.dat w]
set outfile33 [open ./tail_dna/tail_DNA_mean_contacts_backbone_${name}_h2a_C.dat w]
set outfile34 [open ./tail_dna/tail_DNA_mean_contacts_backbone_${name}_h2a_G.dat w]
set outfile35 [open ./tail_dna/tail_DNA_mean_contacts_base_${name}_h2a_C.dat w]
set outfile36 [open ./tail_dna/tail_DNA_mean_contacts_base_${name}_h2a_G.dat w]

set outfile41 [open ./tail_dna/tail_DNA_mean_contacts_all_${name}_h2b_D.dat w]
set outfile42 [open ./tail_dna/tail_DNA_mean_contacts_all_${name}_h2b_H.dat w]
set outfile43 [open ./tail_dna/tail_DNA_mean_contacts_backbone_${name}_h2b_D.dat w]
set outfile44 [open ./tail_dna/tail_DNA_mean_contacts_backbone_${name}_h2b_H.dat w]
set outfile45 [open ./tail_dna/tail_DNA_mean_contacts_base_${name}_h2b_D.dat w]
set outfile46 [open ./tail_dna/tail_DNA_mean_contacts_base_${name}_h2b_H.dat w]
